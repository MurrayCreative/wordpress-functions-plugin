			...
			<div class="section-wrapper" id="section-admin">
				...
				<fieldset class="studio_manager-admin-menu-items">
					<legend class="screen-reader-text"><?php _e('Hide Admin menu items for editors', $this->plugin_name);?></legend>
					...
					<?php
						...
						foreach($all_menu_items as $menu_key => $menu_value):
							if($menu_value[0]):
								...
								<?php esc_attr_e("Hide ".$menu_label." menu item", $this->plugin_name);?>
								</label>
								<br/>
								<?php
							endif;
				...
				<fieldset>
					<legend class="screen-reader-text"><?php _e('Remove WordPress Icon from admin bar', $this->plugin_name);?></legend>
					...
					<label for="<?php echo $this->plugin_name;?>-remove_admin_bar_icon">
						...
						<?php esc_attr_e('Remove WordPress Icon', $this->plugin_name);?>
					</label>
				</fieldset>
				...
				<fieldset>
					<legend class="screen-reader-text"><?php _e('Change Admin footer text with your own', $this->plugin_name);?></legend>
					<h3 class="section-subheading"><?php esc_attr_e('Change Admin footer text with your own', $this->plugin_name);?></h3>
					<input type="text" class="regular-text" id="<?php echo $this->plugin_name;?>-admin_footer_text" name="<?php echo $this->plugin_name;?>[admin_footer_text]" value="<?php if(!empty($admin_footer_text)) esc_attr_e($admin_footer_text, $this->plugin_name);?>" placeholder="<?php esc_attr_e('Built with WordPress', $this->plugin_name);?>" />
				</fieldset>
