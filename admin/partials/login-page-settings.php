			...
			<div class="section-wrapper" id="section-login">
				...
				<fieldset>
					...
					<legend class="screen-reader-text"><?php esc_attr_e('Login Logo', $this->plugin_name);?></legend>
					<label for="<?php echo $this->plugin_name;?>-login_logo">
						...
						<?php esc_attr_e('Login Logo', $this->plugin_name);?>
					</label>
					<div id="upload_logo_preview" class="studio-manager-upload-preview <?php if(empty($login_logo_id)) echo 'hidden'?>">
						...
						<button id="studio-manager-delete_logo_button" class="studio-manager-delete-image" title="Remove Logo"></button>
					</div>
				</fieldset>

				<!-- login logo link to homepage instead of wordpress.org -->
				<fieldset>
					<legend class="screen-reader-text"><?php _e('Link Login Logo to homepage instead of WordPress.org', $this->plugin_name);?></legend>
					<label for="<?php echo $this->plugin_name;?>-login_logo_link">
						...
						<?php esc_attr_e('Link Login Logo to homepage instead of WordPress.org', $this->plugin_name);?>
					</label>
				</fieldset>
