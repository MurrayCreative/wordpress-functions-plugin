			...
			<div class="section-wrapper" id="section-cleanup">
				...
				<fieldset>
					<legend class="screen-reader-text"><?php _e('Clean WordPress head section', $this->plugin_name);?></legend>
					<label for="<?php echo $this->plugin_name;?>-cleanup">
						...
						<?php esc_attr_e( 'Clean up the head section', $this->plugin_name ); ?>
					</label>
				</fieldset>
				...
				<fieldset>
					<legend class="screen-reader-text"><?php _e('Add Post, page or product slug to body class', $this->plugin_name);?></legend>
					<label for="<?php echo $this->plugin_name;?>-body_class_slug">
						...
						<?php esc_attr_e('Add Post slug to body class', $this->plugin_name);?>
					</label>
				</fieldset>
				...
				<!-- Prettify Search URL -->
				<fieldset>
					<legend class="screen-reader-text"><?php _e('Prettify Search URL - http://yourwebsite/search/search_terms/', $this->plugin_name);?></legend>
					<label for="<?php echo $this->plugin_name;?>-prettify_search">
						...
						<?php esc_attr_e('Prettify Search URL (eg: http://yourwebsite/search/search_terms/)', $this->plugin_name);?>
					</label>
				</fieldset>
				...
				<!-- Hide Admin Bar -->
				<fieldset>
					<legend class="screen-reader-text"><?php _e('Hide Admin Bar on the Front-end', $this->plugin_name);?></legend>
					<label for="<?php echo $this->plugin_name;?>-hide_admin_bar">
						...
						<?php esc_attr_e('Hide Admin Bar', $this->plugin_name);?>
					</label>
				</fieldset>
				...
				<fieldset>
					<legend class="screen-reader-text"><?php _e('Remove CSS and JS files query string versions', $this->plugin_name);?></legend>
					<label for="<?php echo $this->plugin_name;?>-css_js_versions">
						...
						<?php esc_attr_e('Remove CSS and JS versions (uncheck for dev)', $this->plugin_name);?>
					</label>
				</fieldset>
